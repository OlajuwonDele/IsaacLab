...
def main():
    ...
    # First call sets up the instancer for N markers
    ee_marker.visualize(translations=dummy_trans, orientations=dummy_orient)
    goal_marker.visualize(translations=dummy_trans, orientations=dummy_orient)
    ...
    while simulation_app.is_running():
        ...
        # inside loop, after ee_pose and goal are computed:

        # ee_pose is already (N,7) from robot.data.body_pose_w[:, ee_body_id]
